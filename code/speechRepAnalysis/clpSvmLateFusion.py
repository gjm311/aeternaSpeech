...
def featAgg(model,reps,spk_path):
    ...
    for rIdx,rep in enumerate(reps):
        ...
        rep_dict[rep]['data'],rep_dict[rep]['ncs']=getDataset(spkdict,clpNames,hcNames)
    
    pca_xAlls=[rep_dict[rep]['data'] for rep in reps]
    rncs=[rep_dict[rep]['ncs'] for rep in reps]
    return pca_xAlls,rncs,clpNames,hcNames,{**clpNames_count,**hcNames_count}
...
if __name__=="__main__":
    ...
    pca_xAlls,rncs,clpNames,hcNames,name_count=featAgg(model,reps,spk_path)
